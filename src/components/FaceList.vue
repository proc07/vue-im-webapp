<template>
  <div class="face-wrapper">
    <div class="face-tabs">
      <div class="qq_face" v-show="currentTab === 'qq'">
        <div
          class="item-box"
    ...
    <div class="bottom-tabs">
      <div class="item" @click="currentTab = 'qq'">QQ表情</div>
      <div class="item" @click="currentTab = 'wx'">微信表情</div>
      <div class="item" @click="currentTab = 'emoji'">emoji</div>
      <div class="item del-btn" @click="onDelFace">删除</div>
    </div>
  </div>
</template>
...
export default {
  ...
  created () {
    console.log('emojiSupported', this.emojiSupported())
  },
  methods: {
    emojiSupported () {
